    ...
    <div class="form-section">
        ...
        <div class="form-grid">
            ...
            <div class="form-group">
                ...
                <input type="text" name="cement_mill_note" value="{{ old('cement_mill_note') }}" placeholder="Contoh: Operasional lancar">
            </div>

            <div class="form-group">
                <label>Feed</label>
                <input type="number" step="0.01" min="0" name="feed" value="{{ old('feed') }}" placeholder="0.00">
            </div>

            <div class="form-group">
                <label>Blaine</label>
                <input type="number" step="0.01" min="0" name="blaine" value="{{ old('blaine') }}" placeholder="0.00">
            </div>

            <div class="form-group">
                <label>Sieving</label>
                <input type="number" step="0.01" min="0" name="sieving" value="{{ old('sieving') }}" placeholder="0.00">
            </div>

            <div class="form-group">
                <label>Produksi 00.00 s/d 07.00</label>
                <input type="number" step="0.01" min="0" name="production_cm" value="{{ old('production_cm') }}" placeholder="0.00">
            </div>

            <div class="form-group">
                <label>Running Hours</label>
                <input type="number" step="0.01" min="0" name="running_hours" value="{{ old('running_hours') }}" placeholder="0.00">
            </div>

            <div class="form-group">
                <label>Clinker Factor</label>
                <input type="number" step="0.01" min="0" name="clinker_factor" value="{{ old('clinker_factor') }}" placeholder="0.00">
            </div>

            <div class="form-group">
                <label>Silo Semen</label>
                <input type="number" step="0.01" min="0" name="silo_semen" value="{{ old('silo_semen') }}" placeholder="0.00">
            </div>
        </div>
    </div>
    ...
    <div class="form-section">
        ...
        <div class="form-grid">
            ...
            <div class="form-group">
                ...
                <input type="text" name="packer1_note" value="{{ old('packer1_note') }}" placeholder="Contoh: Operasional lancar">
            </div>
            ...
            <div class="form-group">
                ...
                <input type="text" name="packer2_note" value="{{ old('packer2_note') }}" placeholder="Contoh: Operasional lancar">
            </div>
        </div>
    </div>
    ...
    <div class="form-section">
        ...
        <div class="form-grid">
            <div class="form-group">
                ...
                <input type="number" min="0" name="truck_packer_area" value="{{ old('truck_packer_area') }}" placeholder="0">
            </div>

            <div class="form-group">
                <label>Area Emplacement</label>
                <input type="number" min="0" name="truck_emplacement_area" value="{{ old('truck_emplacement_area') }}" placeholder="0">
            </div>
        </div>
    </div>
    ...
    <div class="form-section">
        ...
        <div class="form-grid">
            <div class="form-group">
                ...
                <input type="number" step="0.01" min="0" name="production_packer" value="{{ old('production_packer') }}" placeholder="0.00">
            </div>
        </div>
    </div>
